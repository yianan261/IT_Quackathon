    ...
    automation_instruction = {
        ...
        "steps": [
            # 步骤1: 点击 Workday 卡片
            {
                ...
                "wait_before_click": 1000,  # 增加点击前等待时间
            ...
            # 步骤2: 点击 Academics 按钮
            {
                ...
                "selector": "button[data-automation-id*='academics' i], button[aria-label*='Academics' i]",
                "fallback_selectors": [
                    # 基于标题和文本的选择器
                ...
                "wait_before_click": 3000,  # 增加等待时间，确保页面完全加载
            ...
            {
                "action": "click",
                "description": "Find Course Sections option",
                "selector": "div[title='Find Course Sections']",  # 主选择器，基于title属性
                "fallback_selectors": [
                    # 基于类和文本内容的选择器
                ...
                "wait_before_click": 4000,  # 增加等待时间，确保元素完全加载和可点击
                "timeout": 25000,  # 增加超时时间
                "critical": True   # 标记为关键操作
            },
            # 步骤4: 验证 Find Course Sections 对话框是否出现
            {
                ...
                "description": "Find Course Sections dialog",
                "selector": "[data-automation-id='editPopup'][aria-modal='true']",  # 主选择器，基于自动化ID和modal属性
                "fallback_selectors": [
                    # 基于role和其他属性的选择器
                ...
                "wait_after_verify": 1000,  # 验证后等待时间，避免过快进行下一步
                "critical": True   # 标记为关键操作
            },
